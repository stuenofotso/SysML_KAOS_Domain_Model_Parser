...
\EVT{\_connectTrain}{true}{ordinary}{\_connectTrain}{}{
	...
	\GUARDS{true}{
		...
		\Guard{grd9}{false}{$integer=TRUE \limp{}(\forall{}tr1\qdot{}(tr1\in{}dom(front)\setminus{}dom(rear)\limp{}front(tr1) < re))$}{true}{}
		\Guard{grd10}{false}{$integer=FALSE \limp{}(\forall{}tr1\qdot{}(tr1\in{}dom(rear)\limp{}fr < rear(tr1)))$}{true}{}
...
\EVT{\_connectTrain}{true}{ordinary}{\_connectTrain}{}{
	...
	\GUARDS{true}{
		...
		\Guard{grd9}{false}{$integer=TRUE \limp{}(\forall{}tr1\qdot{}(tr1\in{}dom(front)\setminus{}dom(rear)\limp{}front(tr1) < re))$}{false}{}
		\Guard{grd10}{false}{$integer=FALSE \limp{}(\forall{}tr1\qdot{}(tr1\in{}dom(rear)\limp{}fr < rear(tr1)))$}{false}{}
		\Guard{grd11}{false}{$integer=FALSE \limp{}(\forall{}tr1,ttd\qdot{}((tr1\in{}dom(front)\setminus{}dom(rear)\land{}ttd\in{}TTD\land{}front(tr1)\in{}ttd)\limp{}fr \notin{} ttd))$}{false}{}
	}
	\ACTIONS{true}{
		\Action{act1}{$connectedTrain(tr) \bcmeq{} TRUE$}{false}{}
...
\EVT{MoveTrainFollowingItsMA}{true}{ordinary}{MoveTrainFollowingItsMA}{}{
	...
	\GUARDS{true}{
		...
		\Guard{grd2}{false}{$len \in{} \natn{}$}{false}{}
		\Guard{grd3}{false}{$front(tr)+len \in{} MA(tr)$}{false}{}
		\Guard{grd4}{false}{$ttds \subseteq{} stateTTD\converse{}[\{FREE\}]$}{false}{}
		\Guard{grd5}{false}{$\forall{}ttd\qdot{}(ttd\in{}stateTTD\converse{}[\{FREE\}] \land{} ((front(tr)+len\in{}ttd) \lor{} (tr\in{}dom(rear)\land{}((rear(tr)+len\upto{}front(tr)+len)\binter{}ttd\neq{}\emptyset{})))\limp{}ttd\in{}ttds)$}{false}{}
		\Guard{grd6}{false}{$tr\in{}dom(rear)\limp{}(\forall{}tr1\qdot{}((tr1\in{}dom(rear)\land{}tr1\neq{}tr)\limp{}(rear(tr1)\upto{}front(tr1))\binter{}(rear(tr)+len\upto{}front(tr)+len)=\emptyset{}))$}{false}{}
		\Guard{grd7}{false}{$tr\in{}dom(rear)\limp{}(\forall{}tr1\qdot{}((tr1\in{}dom(front)\setminus{}dom(rear)\land{}tr1\neq{}tr)\limp{}front(tr1) < rear(tr)+len))$}{false}{}
		\Guard{grd8}{false}{$tr\in{}dom(front)\setminus{}dom(rear)\limp{}(\forall{}tr1\qdot{}((tr1\in{}dom(rear)\land{}tr1\neq{}tr)\limp{}front(tr)+len < rear(tr1)))$}{false}{}
		\Guard{grd9}{false}{$tr\in{}dom(front)\setminus{}dom(rear)\limp{}(\forall{}tr1,ttd\qdot{}((tr1\in{}dom(front)\setminus{}dom(rear)\land{}tr1\neq{}tr\land{}ttd\in{}TTD\land{}front(tr1)\in{}ttd)\limp{}front(tr)+len \notin{} ttd))$}{false}{}
	}
	\ACTIONS{true}{
		\Action{act1}{$front(tr) \bcmeq{} front(tr)+len$}{false}{}
...
\EVT{\_toggleTrainConnexionStatus}{true}{ordinary}{\_toggleTrainConnexionStatus}{}{
	...
	\ACTIONS{true}{
		\Action{act1}{$connectedTrain \bcmeq{} (\{TRUE\mapsto{}connectedTrain\ovl{}\{tr\mapsto{}FALSE\}, FALSE\mapsto{}connectedTrain\ovl{}\{tr\mapsto{}TRUE\}\})(bool(connectedTrain(tr)=TRUE))$}{false}{}
		\Action{act2}{$muteTimer \bcmeq{} (\{TRUE\mapsto{}muteTimer, FALSE\mapsto{}muteTimer\ovl{}\{tr\mapsto{}STARTED\}\})(bool(connectedTrain(tr)=TRUE))$}{true}{}
	}
}
\EVT{MoveTrainFollowingItsMA}{true}{ordinary}{MoveTrainFollowingItsMA}{}{
	\ANY{
