...
public class StructureAspectDescriptor extends BaseStructureAspectDescriptor {
  ...
  /*package*/ final ConceptDescriptor myConceptAttributeDomain = createDescriptorForAttributeDomain();
  /*package*/ final ConceptDescriptor myConceptAttributeMaplet = createDescriptorForAttributeMaplet();
  /*package*/ final ConceptDescriptor myConceptAttributeRange = createDescriptorForAttributeRange();
  ...
  /*package*/ final ConceptDescriptor myConceptDataSetPower = createDescriptorForDataSetPower();
  /*package*/ final ConceptDescriptor myConceptDataValue = createDescriptorForDataValue();
  /*package*/ final ConceptDescriptor myConceptDeducedConcept = createDescriptorForDeducedConcept();
  ...
  /*package*/ final ConceptDescriptor myConceptRelationDomain = createDescriptorForRelationDomain();
  /*package*/ final ConceptDescriptor myConceptRelationMaplet = createDescriptorForRelationMaplet();
  /*package*/ final ConceptDescriptor myConceptRelationRange = createDescriptorForRelationRange();
  ...
  public Collection<ConceptDescriptor> getDescriptors() {
    return Arrays.asList(myConceptAtom, myConceptAttribute, myConceptAttributeAtom, myConceptAttributeDomain, myConceptAttributeMaplet, myConceptAttributeRange, myConceptBody, myConceptBuiltInAtom, myConceptCardinality, myConceptConcept, myConceptConceptAtom, myConceptCustomDataSet, myConceptDataSet, myConceptDataSetAtom, myConceptDataSetPower, myConceptDataValue, myConceptDeducedConcept, myConceptDefaultDataSet, myConceptDomainCardinality, myConceptDomainModel, myConceptEnumeratedDataSet, myConceptEqualityAtom, myConceptHead, myConceptIndividual, myConceptInequalityAtom, myConceptPredicate, myConceptRangeCardinality, myConceptRelation, myConceptRelationAtom, myConceptRelationDomain, myConceptRelationMaplet, myConceptRelationRange, myConceptTerm, myConceptVariable);
  }
  ...
  public ConceptDescriptor getDescriptor(SConceptId id) {
    switch (myConceptIndex.index(id)) {
      ...
      case LanguageConceptSwitch.AttributeDomain:
        return myConceptAttributeDomain;
      case LanguageConceptSwitch.AttributeMaplet:
        return myConceptAttributeMaplet;
      case LanguageConceptSwitch.AttributeRange:
        return myConceptAttributeRange;
      ...
      case LanguageConceptSwitch.DataSetPower:
        return myConceptDataSetPower;
      case LanguageConceptSwitch.DataValue:
        return myConceptDataValue;
      case LanguageConceptSwitch.DeducedConcept:
        return myConceptDeducedConcept;
      ...
      case LanguageConceptSwitch.RelationDomain:
        return myConceptRelationDomain;
      case LanguageConceptSwitch.RelationMaplet:
        return myConceptRelationMaplet;
      case LanguageConceptSwitch.RelationRange:
        return myConceptRelationRange;
  ...
  private static ConceptDescriptor createDescriptorForAttribute() {
    ...
    b.prop("isTotal", 0x1eb45a00d15c2815L, "2212492276504733717");
  ...
  private static ConceptDescriptor createDescriptorForAttributeDomain() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("SysMLKaosDomainModeling", "AttributeDomain", 0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x1eb45a00d1617aa5L);
    b.class_(false, false, false);
    b.super_("SysMLKaosDomainModeling.structure.Concept", 0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x506f581469497f85L);
    b.parent(0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x1eb45a00d1b8a7d7L);
    b.origin("r:0069f631-891a-4ca2-904e-aa2fe791c6ed(SysMLKaosDomainModeling.structure)/2212492276505082533");
    b.associate("attribute", 0x1eb45a00d1617ac3L).target(0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x506f58146949819aL).optional(false).origin("2212492276505082563").done();
    return b.create();
  }
  ...
  private static ConceptDescriptor createDescriptorForAttributeRange() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("SysMLKaosDomainModeling", "AttributeRange", 0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x1eb45a00d1b8a7fcL);
    b.class_(false, false, false);
    b.super_("SysMLKaosDomainModeling.structure.CustomDataSet", 0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x506f581469498071L);
    b.parent(0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x1eb45a00d1b8a7d7L);
    b.origin("r:0069f631-891a-4ca2-904e-aa2fe791c6ed(SysMLKaosDomainModeling.structure)/2212492276510795772");
    b.associate("attribute", 0x1eb45a00d1b8a7fdL).target(0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x506f58146949819aL).optional(false).origin("2212492276510795773").done();
    return b.create();
  }
  ...
  private static ConceptDescriptor createDescriptorForDataSetPower() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("SysMLKaosDomainModeling", "DataSetPower", 0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x1eb45a00d1e07966L);
    b.class_(false, false, false);
    b.super_("SysMLKaosDomainModeling.structure.CustomDataSet", 0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x506f581469498071L);
    b.parent(0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x1eb45a00d1b8a7d7L);
    b.origin("r:0069f631-891a-4ca2-904e-aa2fe791c6ed(SysMLKaosDomainModeling.structure)/2212492276513405286");
    b.associate("dataSet", 0x1eb45a00d1e07967L).target(0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x506f581469497faaL).optional(false).origin("2212492276513405287").done();
    return b.create();
  }
  ...
  private static ConceptDescriptor createDescriptorForDeducedConcept() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("SysMLKaosDomainModeling", "DeducedConcept", 0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x1eb45a00d1b8a7d7L);
    b.interface_();
    b.origin("r:0069f631-891a-4ca2-904e-aa2fe791c6ed(SysMLKaosDomainModeling.structure)/2212492276510795735");
    return b.create();
  }
  ...
  private static ConceptDescriptor createDescriptorForDomainModel() {
    ...
    b.aggregate("deducedConcepts", 0x1eb45a00d18e725fL).target(0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x1eb45a00d1b8a7d7L).optional(true).ordered(true).multiple(true).origin("2212492276508029535").done();
    ...
    b.aggregate("dataValues", 0x1eb45a00d18e7200L).target(0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x506f5814694980ebL).optional(true).ordered(true).multiple(true).origin("2212492276508029440").done();
  ...
  private static ConceptDescriptor createDescriptorForRelation() {
    ...
    b.associate("parentRelation", 0x14c6cabde4d8361fL).target(0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x506f58146949824cL).optional(true).origin("1497106843084273183").done();
  ...
  private static ConceptDescriptor createDescriptorForRelationDomain() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("SysMLKaosDomainModeling", "RelationDomain", 0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x1eb45a00d1b8de57L);
    b.class_(false, false, false);
    b.super_("SysMLKaosDomainModeling.structure.Concept", 0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x506f581469497f85L);
    b.parent(0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x1eb45a00d1b8a7d7L);
    b.origin("r:0069f631-891a-4ca2-904e-aa2fe791c6ed(SysMLKaosDomainModeling.structure)/2212492276510809687");
    b.associate("relation", 0x1eb45a00d1b8de58L).target(0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x506f58146949824cL).optional(false).origin("2212492276510809688").done();
    return b.create();
  }
  ...
  private static ConceptDescriptor createDescriptorForRelationRange() {
    ConceptDescriptorBuilder2 b = new ConceptDescriptorBuilder2("SysMLKaosDomainModeling", "RelationRange", 0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x1eb45a00d1b8de75L);
    b.class_(false, false, false);
    b.super_("SysMLKaosDomainModeling.structure.Concept", 0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x506f581469497f85L);
    b.parent(0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x1eb45a00d1b8a7d7L);
    b.origin("r:0069f631-891a-4ca2-904e-aa2fe791c6ed(SysMLKaosDomainModeling.structure)/2212492276510809717");
    b.associate("relation", 0x1eb45a00d1b8de76L).target(0x9715e310dbcb448eL, 0x93035bfaafdcf84dL, 0x506f58146949824cL).optional(false).origin("2212492276510809718").done();
    return b.create();
  }
