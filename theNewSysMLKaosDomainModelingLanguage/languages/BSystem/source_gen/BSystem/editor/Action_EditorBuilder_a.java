...
/*package*/ class Action_EditorBuilder_a extends AbstractEditorBuilder {
  ...
  private EditorCell createCollection_8bscln_a() {
    ...
    editorCell.addEditorCell(createConstant_8bscln_h0());
    editorCell.addEditorCell(createConstant_8bscln_i0());
    editorCell.addEditorCell(createProperty_8bscln_j0());
    editorCell.addEditorCell(createConstant_8bscln_k0());
    return editorCell;
  }
  ...
  private EditorCell createRefNode_8bscln_f0() {
    SingleRoleCellProvider provider = new Action_EditorBuilder_a.commentSingleRoleHandler_8bscln_f0(myNode, MetaAdapterFactory.getContainmentLink(0xbe9c247ddd744e87L, 0x98fb8757587ebb62L, 0x47342804c1924333L, 0x5b61b7c2a5e6dd2aL, "comment"), getEditorContext());
    return provider.createCell();
  }
  private static class commentSingleRoleHandler_8bscln_f0 extends SingleRoleCellProvider {
    @NotNull
    private SNode myNode;

    public commentSingleRoleHandler_8bscln_f0(SNode ownerNode, SContainmentLink containmentLink, EditorContext context) {
  ...
  private EditorCell createConstant_8bscln_h0() {
  ...
  private EditorCell createConstant_8bscln_i0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ":");
  ...
  private EditorCell createProperty_8bscln_j0() {
    CellProviderWithRole provider = new PropertyCellProvider(myNode, getEditorContext());
  ...
  private EditorCell createConstant_8bscln_k0() {
    EditorCell_Constant editorCell = new EditorCell_Constant(getEditorContext(), myNode, ")");
